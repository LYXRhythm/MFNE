# MFNE
Yongxiang Li, Xinyu Su, Weili Jiang, Gadeng Luosang, Hongmei Chen, and **Zhong Yuan***. Granular-Ball Fuzzy Neighborhood Entropy-based Outlier Detector (IEEE Transactions on Fuzzy Systems, Python Code)
